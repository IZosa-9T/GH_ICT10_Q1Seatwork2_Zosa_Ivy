...
display(f'{menu_prices[1]} ₱', target='Ice_cream_price')

display(f'{product_flavor} {product_names[1]}', target='Cake_product')
display(f'{menu_prices[4]} ₱', target='Cake_price')
...
display(f'{menu_prices[2]} ₱', target='Yogurt_price')

display(f'{product_flavor} {product_names[4]}', target='Pudding_product')
display(f'{menu_prices[3]} ₱', target='Pudding_price')
